...
const validatePostBlog=[
    ...
    check("category").isArray().withMessage("The category must be an array").optional(),
]

const validatePostReview=[
    check("content").notEmpty().withMessage("The content field is required").isString(),
    check("blogId").notEmpty().withMessage("The blogId is missing").isString(),
]
module.exports={validateAuthRegister,validateAuthLogin,validatePostBlog,validatePostReview};
